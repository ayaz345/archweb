...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'url',
                    models.CharField(
                        max_length=255, null=True, verbose_name='URL'
                    ),
                ),
                ...
                (
                    'packager_str',
                    models.CharField(
                        max_length=255, verbose_name='packager string'
                    ),
                ),
                (
                    'signature_bytes',
                    models.BinaryField(
                        verbose_name='PGP signature', null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'pkg',
                    models.ForeignKey(
                        to='main.Package', on_delete=django.db.models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='package', unique_together={('pkgname', 'repo', 'arch')}
        ),
    ]
